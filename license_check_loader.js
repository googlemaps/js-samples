...
const NODE_MODULES_ROOT = 'npm/node_modules';
const BIN_DIR = 'bazel-out/k8-fastbuild/bin';
const ENTRY_POINT = 'npm/node_modules/license-check-and-add/dist/src/cli.js';
const GEN_DIR = 'bazel-out/k8-fastbuild/bin';
const INSTALL_SOURCE_MAP_SUPPORT = false;
const TARGET = '//:license_check';
