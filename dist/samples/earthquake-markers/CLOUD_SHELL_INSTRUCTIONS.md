# Run earthquake-markers in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/earthquake-markers), and runs `npm i` followed by `npm run dev`.
