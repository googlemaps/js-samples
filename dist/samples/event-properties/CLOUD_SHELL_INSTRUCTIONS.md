# Run event-properties in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the event-properties using TypeScript, Babel, and Webpack.
