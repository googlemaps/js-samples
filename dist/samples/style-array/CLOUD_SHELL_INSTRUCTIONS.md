# Run style-array in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the style-array using TypeScript, Babel, and Webpack.
