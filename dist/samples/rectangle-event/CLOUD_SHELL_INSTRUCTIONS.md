...
This tutorial will walk through the process of running a web application from the `rectangle-event` sample using TypeScript, Babel, and Webpack.
...
```bash
googlemaps-js-samples init -v --no-open --no-hot rectangle-event .
```
