# Run vector-use-static-map in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/vector-use-static-map), and runs `npm i` followed by `npm run dev`.
