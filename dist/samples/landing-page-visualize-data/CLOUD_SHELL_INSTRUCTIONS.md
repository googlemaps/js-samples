# Run landing-page-visualize-data in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the landing-page-visualize-data using TypeScript, Babel, and Webpack.
