# Run maptype-styled-simple in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the maptype-styled-simple using TypeScript, Babel, and Webpack.
