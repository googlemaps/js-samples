# Run overlay-remove in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the overlay-remove using TypeScript, Babel, and Webpack.
