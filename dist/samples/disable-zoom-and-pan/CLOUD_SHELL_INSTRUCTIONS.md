# Run disable-zoom-and-pan in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/disable-zoom-and-pan), and runs `npm i` followed by `npm run dev`.
