# Run split-map-panes in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/split-map-panes), and runs `npm i` followed by `npm run dev`.
