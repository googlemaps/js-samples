# Run layer-data-quakes-red in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/layer-data-quakes-red), and runs `npm i` followed by `npm run dev`.
