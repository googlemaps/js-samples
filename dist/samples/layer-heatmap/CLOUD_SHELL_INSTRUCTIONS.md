# Run layer-heatmap in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the layer-heatmap using TypeScript, Babel, and Webpack.
