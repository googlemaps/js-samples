# Run aerial-rotation in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the aerial-rotation using TypeScript, Babel, and Webpack.
