# Run style-selector in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the style-selector using TypeScript, Babel, and Webpack.
