# Run add-map in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/add-map), and runs `npm i` followed by `npm run dev`.
