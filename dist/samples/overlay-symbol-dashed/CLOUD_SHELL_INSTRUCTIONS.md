# Run overlay-symbol-dashed in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the overlay-symbol-dashed using TypeScript, Babel, and Webpack.
