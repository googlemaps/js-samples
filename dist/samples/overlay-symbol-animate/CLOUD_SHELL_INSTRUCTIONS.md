# Run overlay-symbol-animate in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the overlay-symbol-animate using TypeScript, Babel, and Webpack.
