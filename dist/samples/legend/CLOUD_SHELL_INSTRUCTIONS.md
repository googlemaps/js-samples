# Run legend in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the legend using TypeScript, Babel, and Webpack.
