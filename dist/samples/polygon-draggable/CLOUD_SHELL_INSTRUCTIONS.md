# Run polygon-draggable in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the polygon-draggable using TypeScript, Babel, and Webpack.
