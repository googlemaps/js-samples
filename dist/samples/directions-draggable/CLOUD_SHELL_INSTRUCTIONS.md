# Run directions-draggable in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the directions-draggable using TypeScript, Babel, and Webpack.
