# Run directions-complex in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the directions-complex using TypeScript, Babel, and Webpack.
