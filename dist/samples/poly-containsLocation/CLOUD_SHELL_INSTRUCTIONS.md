# Run poly-containsLocation in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the poly-containsLocation using TypeScript, Babel, and Webpack.
