# Run rectangle-zoom in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the rectangle-zoom using TypeScript, Babel, and Webpack.
