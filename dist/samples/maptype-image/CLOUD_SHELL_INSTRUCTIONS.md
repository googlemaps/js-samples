# Run maptype-image in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the maptype-image using TypeScript, Babel, and Webpack.
