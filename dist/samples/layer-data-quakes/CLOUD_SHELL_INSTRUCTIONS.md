# Run layer-data-quakes in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the layer-data-quakes using TypeScript, Babel, and Webpack.
