# Run event-poi in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the event-poi using TypeScript, Babel, and Webpack.
