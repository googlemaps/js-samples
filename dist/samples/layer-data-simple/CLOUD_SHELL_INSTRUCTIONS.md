# Run layer-data-simple in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the layer-data-simple using TypeScript, Babel, and Webpack.
