# Run places-placeid-geocoder in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/places-placeid-geocoder), and runs `npm i` followed by `npm run dev`.
