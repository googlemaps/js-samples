# Run streetview-controls in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/streetview-controls), and runs `npm i` followed by `npm run dev`.
