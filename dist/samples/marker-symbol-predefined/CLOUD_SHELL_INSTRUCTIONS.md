# Run marker-symbol-predefined in Google Cloud Shell
...
The command loads the skeleton application, changes to the destination directory(~/marker-symbol-predefined), and runs `npm i` followed by `npm run dev`.
