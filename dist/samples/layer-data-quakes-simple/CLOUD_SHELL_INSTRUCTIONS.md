# Run layer-data-quakes-simple in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the layer-data-quakes-simple using TypeScript, Babel, and Webpack.
