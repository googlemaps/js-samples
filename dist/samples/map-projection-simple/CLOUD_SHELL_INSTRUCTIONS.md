# Run map-projection-simple in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the map-projection-simple using TypeScript, Babel, and Webpack.
