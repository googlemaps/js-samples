# Run layer-transit in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the layer-transit using TypeScript, Babel, and Webpack.
