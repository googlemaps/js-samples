# Run control-positioning-labels in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the control-positioning-labels using TypeScript, Babel, and Webpack.
