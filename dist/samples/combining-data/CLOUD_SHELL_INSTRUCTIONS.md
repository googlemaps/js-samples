# Run combining-data in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the combining-data using TypeScript, Babel, and Webpack.
