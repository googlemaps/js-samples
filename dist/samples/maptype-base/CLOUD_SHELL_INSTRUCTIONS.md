# Run maptype-base in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the maptype-base using TypeScript, Babel, and Webpack.
