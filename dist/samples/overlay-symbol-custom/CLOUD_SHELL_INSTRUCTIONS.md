# Run overlay-symbol-custom in Google Cloud Shell

## Introduction

This tutorial will walk through the process of running a web application from the overlay-symbol-custom using TypeScript, Babel, and Webpack.
