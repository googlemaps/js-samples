...
export RUNFILES
export BAZEL_TARGET=//samples/landing-page-marker-clustering:json
...
MAIN=$(rlocation "googlemaps_js_samples/samples/landing-page-marker-clustering/json_loader.js")
