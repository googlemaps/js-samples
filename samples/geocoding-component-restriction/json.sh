...
export RUNFILES
export BAZEL_TARGET=//samples/geocoding-component-restriction:json
...
MAIN=$(rlocation "googlemaps_js_samples/samples/geocoding-component-restriction/json_loader.js")
