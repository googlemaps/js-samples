 ...
 */function c(){const n=new google.maps.Map(document.getElementById("map"),{zoom:13,center:{lat:51.501904,lng:-.115871}});new google.maps.TransitLayer().setMap(n)}window.initMap=c;
