...
// [START dds_datasets_polygon_click]
let map;
let lastClickedFeatureIds = [];
let datasetLayer;

// [START dds_datasets_polygon_click_eventhandler]
...
// [END dds_datasets_polygon_click_eventhandler]

// [START dds_datasets_polygon_click_stylefunction]
...
// [END dds_datasets_polygon_click_stylefunction]
...
function initMap() {
    ...
    datasetLayer.style = setStyle;
    // [START dds_datasets_polygon_click_addlistener]
    datasetLayer.addListener('click', handleClick);
    // [END dds_datasets_polygon_click_addlistener]
...
// [END dds_datasets_polygon_click]
export { };