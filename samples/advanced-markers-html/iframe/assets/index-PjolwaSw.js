(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
 */async function r(){const{Map:i}=await google.maps.importLibrary("maps");await google.maps.importLibrary("marker");const s={lat:37.43238031167444,lng:-122.16795397128632},o=new i(document.getElementById("map"),{zoom:11,center:s,mapId:"4504f8b37365c3d0"});for(const a of c){const e=new google.maps.marker.AdvancedMarkerElement({map:o,content:d(a),position:a.position,title:a.description});e.addListener("click",()=>{l(e)})}}function l(i,s){i.content.classList.contains("highlight")?(i.content.classList.remove("highlight"),i.zIndex=null):(i.content.classList.add("highlight"),i.zIndex=1)}function d(i){const s=document.createElement("div");return s.classList.add("property"),s.innerHTML=`
    <div class="icon">
