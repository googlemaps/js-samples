(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function a(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(e){if(e.ep)return;e.ep=!0;const i=a(e);fetch(e.href,i)}})();/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
 */function l(){const t={lat:37.43238031167444,lng:-122.16795397128632},s=new google.maps.Map(document.getElementById("map"),{zoom:11,center:t,mapId:"4504f8b37365c3d0"});for(const a of p){const n=new google.maps.marker.AdvancedMarkerView({map:s,content:c(a),position:a.position,title:a.description}),e=n.element;["focus","pointerenter"].forEach(i=>{e.addEventListener(i,()=>{d(n)})}),["blur","pointerleave"].forEach(i=>{e.addEventListener(i,()=>{r(n)})}),n.addListener("click",i=>{r(n)})}}function d(t,s){t.content.classList.add("highlight"),t.element.style.zIndex=1}function r(t,s){t.content.classList.remove("highlight"),t.element.style.zIndex=""}function c(t){const s=document.createElement("div");return s.classList.add("property"),s.innerHTML=`
    <div class="icon">
