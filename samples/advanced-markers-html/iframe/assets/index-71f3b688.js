 ...
 */async function r(){const{Map:t}=await google.maps.importLibrary("maps");await google.maps.importLibrary("marker");const s={lat:37.43238031167444,lng:-122.16795397128632},o=new t(document.getElementById("map"),{zoom:11,center:s,mapId:"4504f8b37365c3d0"});for(const a of c){const e=new google.maps.marker.AdvancedMarkerElement({map:o,content:d(a),position:a.position,title:a.description});e.addListener("click",()=>{l(e)})}}function l(t,s){t.content.classList.contains("highlight")?(t.content.classList.remove("highlight"),t.zIndex=null):(t.content.classList.add("highlight"),t.zIndex=1)}function d(t){const s=document.createElement("div");return s.classList.add("property"),s.innerHTML=`
    <div class="icon">
