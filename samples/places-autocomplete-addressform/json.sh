...
export RUNFILES
export BAZEL_TARGET=//samples/places-autocomplete-addressform:json
...
MAIN=$(rlocation "googlemaps_js_samples/samples/places-autocomplete-addressform/json_loader.js")
