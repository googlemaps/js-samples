 ...
 */function l(){const r={lat:-25.344,lng:131.031},o=new google.maps.Map(document.getElementById("map"),{zoom:4,center:r});new google.maps.Marker({position:r,map:o})}window.initMap=l;
