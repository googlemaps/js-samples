...
export RUNFILES
export BAZEL_TARGET=//samples/places-autocomplete-multiple-countries:json
...
MAIN=$(rlocation "googlemaps_js_samples/samples/places-autocomplete-multiple-countries/json_loader.js")
