...
const USER_WORKSPACE_NAME = 'googlemaps_js_samples';
const NODE_MODULES_ROOT = 'build_bazel_rules_nodejs/node_modules';
const BIN_DIR = 'bazel-out/k8-fastbuild/bin';
const ENTRY_POINT = 'npm/node_modules/json/lib/json.js';
const GEN_DIR = 'bazel-out/k8-fastbuild/bin';
const INSTALL_SOURCE_MAP_SUPPORT = true;
const TARGET = '//samples/places-autocomplete-multiple-countries:json';
