...
export RUNFILES
export BAZEL_TARGET=//samples/places-autocomplete-hotelsearch:json
...
MAIN=$(rlocation "googlemaps_js_samples/samples/places-autocomplete-hotelsearch/json_loader.js")
