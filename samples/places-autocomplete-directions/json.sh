...
export RUNFILES
export BAZEL_TARGET=//samples/places-autocomplete-directions:json
...
MAIN=$(rlocation "googlemaps_js_samples/samples/places-autocomplete-directions/json_loader.js")
