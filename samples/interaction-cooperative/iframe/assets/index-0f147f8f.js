 ...
 */function c(){const n={lat:-25.363,lng:131.044},r=4;new google.maps.Map(document.getElementById("map"),{zoom:r,center:n,gestureHandling:"cooperative"})}window.initMap=c;
