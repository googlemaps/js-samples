 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function Zf(t){return(e,n)=>{const{slot:r,selector:i}=t!=null?t:{},o="slot"+(r?`[name=${r}]`:":not([name])");return du(e,n,{get(){var a,u;const s=(a=this.renderRoot)==null?void 0:a.querySelector(o),l=(u=s==null?void 0:s.assignedElements(t))!=null?u:[];return i===void 0?l:l.filter(c=>c.matches(i))}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Sh=Symbol("route");class Es extends Oe{getRoute(){var e;return(e=this.route)!=null?e:this.contextRoute}}y([ws({context:Sh,subscribe:!0}),x({attribute:!1}),w("design:type",Object)],Es.prototype,"contextRoute",void 0);y([x({attribute:!1}),w("design:type",Object)],Es.prototype,"route",void 0);/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ld=t=>Xy(t)?t._$litType$.h:t.strings,t0=Ii(class extends Ni{constructor(t){super(t),this.et=new WeakMap}render(t){return[t]}update(t,[e]){const n=od(this.it)?ld(this.it):null,r=od(e)?ld(e):null;if(n!==null&&(r===null||n!==r)){const i=ca(t).pop();let o=this.et.get(n);if(o===void 0){const s=document.createDocumentFragment();o=Xf(U,s),o.setConnected(!1),this.et.set(n,o)}ua(o,[i]),vn(o,void 0,i)}if(r!==null){if(n===null||n!==r){const i=this.et.get(r);if(i!==void 0){const o=ca(i).pop();e0(t),vn(t,void 0,o),ua(t,[o])}}this.it=e}else this.it=void 0;return this.render(e)}});/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
