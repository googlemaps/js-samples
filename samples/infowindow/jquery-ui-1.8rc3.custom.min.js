  ...
  (function(b) {
    ...
    b.fn.extend({
      ...
      scrollParent: function() {
        ...
        return /fixed/.test(this.css("position")) || !c.length
          ? b(document)
          : c;
      },
      zIndex: function(f) {
      ...
      focusable: function(d) {
        ...
        return (
          (/input|select|textarea|button|object/.test(e)
            ...
            ? d.href || !isNaN(c)
            : !isNaN(c)) &&
          !b(d)["area" == e ? "parents" : "closest"](":hidden").length
        );
      },
      tabbable: function(d) {
 ...
 */
/*
 * jQuery UI Widget 1.8rc3https://
 *
 * Copyright (c) 2010 AUTHORS.txt (https://jqueryui.com/about)
 * Dual licensed under the MIT (MIT-LICENSE.txt)
 * https:// (GPL-LICENSE.txt) licenses.
 *
 * https://docs.jquery.com/UI/Widget
 */
(function(b) {
  ...
  b.Widget.prototype = {
    ...
    _trigger: function(d, e, f) {
      ...
      e = b.Event(e);
      e.type = (d === this.widgetEventPrefix
        ? d
  ...
  b.widget("ui.tabs", {
    ...
    _cookie: function() {
      var c =
        this.cookie ||
        (this.cookie =
          this.options.cookie.name || "ui-tabs-" + b.data(this.list[0]));
    ...
    _tabify: function(p) {
          ...
          if (r != "#") {
            ...
            if (!w.length) {
              w = b(e.panelTemplate)
                ...
                .insertAfter(q.panels[s - 1] || q.list);
      ...
      if (p) {
        ...
        e.disabled = b
          .unique(
            e.disabled.concat(
              b.map(this.lis.filter(".ui-state-disabled"), function(r, o) {
        ...
        if (e.selected >= 0 && this.anchors.length) {
          ...
          q.element.queue("tabs", function() {
            q._trigger(
              "show",
              null,
              q._ui(q.anchors[e.selected], q.panels[e.selected])
            );
          });
      ...
      for (var h = 0, n; (n = this.lis[h]); h++) {
        b(n)[
          b.inArray(h, e.disabled) != -1 && !b(n).hasClass("ui-tabs-selected")
            ? "addClass"
            : "removeClass"
        ]("ui-state-disabled");
      }
      ...
      var l = j
        ? function(i, o) {
            ...
            o.hide()
              ...
              .animate(j, j.duration || "normal", function() {
                f(o, j);
      ...
      this.anchors.bind(e.event + ".tabs", function() {
        ...
        if (
          (s.hasClass("ui-tabs-selected") && !e.collapsible) ||
          s.hasClass("ui-state-disabled") ||
          s.hasClass("ui-state-processing") ||
          q._trigger("select", null, q._ui(this, r[0])) === false
        ) {
          this.blur();
          return false;
        }
    ...
    remove: function(c) {
      ...
      e.disabled = b.map(
        b.grep(e.disabled, function(h, g) {
          return h != c;
        }),
        function(h, g) {
          return h >= c ? --h : h;
    ...
    load: function(f) {
      ...
      if (
        !e ||
        (this.element.queue("tabs").length !== 0 && b.data(c, "cache.tabs"))
      ) {
